...
import heroImage from '../assets/gift-a-smile-hero.png'
  ...
  return (
    <div>
      ...
      <div className="relative text-white min-h-[430px] md:min-h-[460px] px-4 overflow-hidden bg-slate-900 flex items-center">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-slate-950/90 via-teal-950/62 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-t from-slate-950/50 via-transparent to-transparent" />
        <div className="max-w-6xl mx-auto w-full relative py-8 md:py-16 text-left">
          <div className="hidden">
            <span className="text-2xl md:text-4xl">🎁</span>
            <h1 className="text-3xl md:text-6xl font-bold tracking-tight">Gift a Smile</h1>
            <span className="text-2xl md:text-4xl">🎁</span>
          </div>
          <h1 className="text-3xl md:text-6xl font-bold tracking-tight mb-1">Gift a Smile</h1>
      ...
      <div className="bg-teal-700 text-white py-5 md:py-10 px-4 text-center">
        ...
        <div className="md:mt-8 md:border-t md:border-teal-600 md:pt-8">
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            {/* WhatsApp */}
            <a href={`https://wa.me/?text=${encodeURIComponent('Check out Gift a Smile — a free platform to give away unused items to people who need them! https://mjaffry01.github.io/i_gift_you/')}`}
              target="_blank" rel="noopener noreferrer" title="Share on WhatsApp"
              className="w-11 h-11 flex items-center justify-center rounded-full bg-[#25D366] hover:bg-[#20ba58] text-white transition-all hover:scale-110 shadow-md">
            ...
            {/* Facebook */}
            <a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fmjaffry01.github.io%2Fi_gift_you%2F"
              target="_blank" rel="noopener noreferrer" title="Share on Facebook"
              className="w-11 h-11 flex items-center justify-center rounded-full bg-[#1877F2] hover:bg-[#1565d8] text-white transition-all hover:scale-110 shadow-md">
            ...
            {/* X / Twitter */}
            <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('Check out Gift a Smile — give away unused items for free to people nearby! #GiftASmile #GiftItForward')}&url=${encodeURIComponent('https://mjaffry01.github.io/i_gift_you/')}`}
              target="_blank" rel="noopener noreferrer" title="Share on X"
              className="w-11 h-11 flex items-center justify-center rounded-full bg-black hover:bg-slate-800 text-white transition-all hover:scale-110 shadow-md">
              <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Fmjaffry01.github.io%2Fi_gift_you%2F"
              target="_blank" rel="noopener noreferrer" title="Share on LinkedIn"
              className="w-11 h-11 flex items-center justify-center rounded-full bg-[#0A66C2] hover:bg-[#0958a8] text-white transition-all hover:scale-110 shadow-md">
            ...
            {/* Telegram */}
            <a href={`https://t.me/share/url?url=${encodeURIComponent('https://mjaffry01.github.io/i_gift_you/')}&text=${encodeURIComponent('Check out Gift a Smile — give away unused items for free to people nearby!')}`}
              target="_blank" rel="noopener noreferrer" title="Share on Telegram"
              className="w-11 h-11 flex items-center justify-center rounded-full bg-[#229ED9] hover:bg-[#1a8bbf] text-white transition-all hover:scale-110 shadow-md">
            ...
            {/* Email */}
            <a href={`mailto:?subject=${encodeURIComponent('Gift a Smile — Free gifts near you!')}&body=${encodeURIComponent('Hey!\n\nI came across this wonderful platform called Gift a Smile where people give away unused items for free to others nearby.\n\nYou can find free toys, books, clothes, shoes, electronics, and more — just connect with the gifter on WhatsApp!\n\nCheck it out: https://mjaffry01.github.io/i_gift_you/\n\nShare love and get love')}`}
              title="Share via Email"
              className="w-11 h-11 flex items-center justify-center rounded-full bg-slate-500 hover:bg-slate-600 text-white transition-all hover:scale-110 shadow-md">
