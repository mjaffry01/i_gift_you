        ...
        <div className="mt-8 border-t border-teal-600 pt-8">
          ...
          <div className="flex items-center justify-center gap-2 flex-wrap max-w-lg mx-auto">
            ...
            <a
              ...
              className="flex items-center gap-1.5 bg-[#25D366] hover:bg-[#20ba58] text-white text-xs font-medium px-3 py-2 rounded-xl transition-colors"
            >
            ...
            <a
              ...
              target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1.5 bg-[#1877F2] hover:bg-[#1565d8] text-white text-xs font-medium px-3 py-2 rounded-xl transition-colors"
            >
            ...
            <a
              ...
              target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1.5 bg-black hover:bg-slate-800 text-white text-xs font-medium px-3 py-2 rounded-xl transition-colors"
            >
              <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-current"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              X
            </a>
            {/* LinkedIn */}
            <a
              ...
              target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1.5 bg-[#0A66C2] hover:bg-[#0958a8] text-white text-xs font-medium px-3 py-2 rounded-xl transition-colors"
            >
            ...
            <a
              ...
              target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1.5 bg-[#229ED9] hover:bg-[#1a8bbf] text-white text-xs font-medium px-3 py-2 rounded-xl transition-colors"
            >
            ...
            <a
              ...
              className="flex items-center gap-1.5 bg-slate-500 hover:bg-slate-600 text-white text-xs font-medium px-3 py-2 rounded-xl transition-colors"
            >
              <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-current"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"/></svg>
              Email
            </a>
          </div>
        </div>
