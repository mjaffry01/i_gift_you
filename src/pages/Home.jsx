      ...
      <div className="bg-teal-700 text-white py-5 md:py-10 px-4 text-center">
        ...
        <div className="md:mt-8 md:border-t md:border-teal-600 md:pt-8">
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            ...
            {/* X / Twitter */}
            <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('Check out I Gift You 🎁 — give away unused items for free to people nearby! #IGiftYou #GiftItForward')}&url=${encodeURIComponent('https://mjaffry01.github.io/i_gift_you/')}`}
            ...
            {/* Telegram */}
            <a href={`https://t.me/share/url?url=${encodeURIComponent('https://mjaffry01.github.io/i_gift_you/')}&text=${encodeURIComponent('Check out I Gift You 🎁 — give away unused items for free to people nearby!')}`}
